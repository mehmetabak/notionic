...
export async function getAllPosts({
  ...
  try {
    ...
    // --- FIX 1: Veri Normalizasyonu (Nested Value Fix) ---
    ...
    for (let i = 0; i < pageIds.length; i++) {
      ...
      try {
        ...
        // Özellikler alınamadıysa atla
        if (!properties) continue
        
        // --- FIX 2: ID Formatlama Düzeltmesi ---
        // pageId zaten tireli bir UUID olabilir. idToUuid fonksiyonu bazen bunu bozar.
        // Önce tireleri temizleyip (strip), sonra temiz formatı idToUuid'ye veriyoruz.
        // Böylece "254e6e97--..." gibi hatalı ID'ler oluşmaz.
