...
export async function getAllPosts({
  ...
  try {
    ...
    // ------------------------------------------------------------------
    // FIX: Loglara göre schema bazen doğrudan erişilebilir değil,
    // iç içe geçmiş bir 'value' objesinin altında bulunuyor.
    // Hem mevcut yapıyı hem de loglardaki yapıyı kontrol ediyoruz.
    // ------------------------------------------------------------------
